//! Shared helpers to build a valid `AppConfig` for tests.
//!
//! Used by unit tests across the crate (security, repositories, controllers,
//! services, middleware). Values are deterministic (seeded RNG) so tests are
//! reproducible while still using realistic key formats.
...
/// Build a deterministic, realistic `AppConfig` for tests.
pub fn test_config() -> AppConfig {
    AppConfig {
        ...
        database_url: "postgres://boilerplate:password@localhost:5432/boilerplate_test".to_string(),
        db_pool_size: 1,
        ...
        email_transport: EmailTransportKind::Resend,
        smtp_url: String::new(),
